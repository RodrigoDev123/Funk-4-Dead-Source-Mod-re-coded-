...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ZombieKillers", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("ZombieKillers", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "ZombieKillers";
		app.meta["name"] = "ZombieKillers";
		...
		#elseif air
		app.window.title = "ZombieKillers";
		#else
