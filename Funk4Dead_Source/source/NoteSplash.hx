...
class NoteSplash extends FlxSprite
{
	...
	function loadAnims(skin:String) {
		...
		for (i in 1...3) {
			...
			case "boomernotesplashes":	
			animation.addByPrefix("note1-" + i, "splashnote", 24, false);
			animation.addByPrefix("note2-" + i, "splashnote", 24, false);
			animation.addByPrefix("note0-" + i,  "splashnote", 24, false);
			animation.addByPrefix("note3-" + i,  "splashnote", 24, false);
			default:
